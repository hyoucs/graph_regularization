function [w,wp,m] = L1Shooting(X, y, lambda,varargin)

%-- DQA: adapted from LassoShooting
%-- elasticNet also call this function!
...
%-- rand leads to the same result, so initbeta not sensitive!
% beta =rand(p,1)
% Start the log
if verbose==2
    w_old = beta;
